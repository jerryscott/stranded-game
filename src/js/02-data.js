...
const SPECIAL = {
 ...
 "1,-1.5":{id:"GENBUILDING",name:"Generator Building",terrain:"indoor",env:"outdoor",light:"lit",
   desc:"A squat cinderblock outbuilding. One door faces southwest. A low hum leaks through the walls.",
   comps:[{t:"man",id:"genbuilding_enter",name:"Generator Building",icon:"🏭",verb:"Enter the building"}]},
...
]; // lake water barriers are implicit: barrierKind() returns "water" for any neighbor with terrain==="lake"
...
const BUILDINGS = []; // GENBUILDING uses sub-map system; add future multi-hex overworld buildings here
