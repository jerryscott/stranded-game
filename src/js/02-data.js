...
const SPECIAL = {
 ...
 "-1,-0.5":{id:"SPRING",name:"The Spring",terrain:"water",env:"outdoor",light:"lit",
   ...
   comps:[{t:"col",id:"spring_water",name:"Clean Spring Water",kind:"water",icon:"💧",consumable:true,effects:{hydration:45,health:5},grab:"You drink deep. Cold, clean, faintly minty. (+45 hydration, +5 health)"},
